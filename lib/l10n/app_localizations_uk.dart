...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get donationSolicitationDialogText =>
      'Привіт! Я автор Wine Bar.\n\nЯ розпочав роботу над проектом улітку 2025 року. З того часу я доклав багато зусиль до нього. Сьогодні Wine Bar вже виконує все, що мені особисто потрібно від нього. Це не означає, що він ідеальний – мої потреби скромні. Тому я можу продовжувати працювати над ним лише тоді, коли зможу виправдати час і енергію, які він потребує.\n\nЩоб розробка продовжувалася, я прошу вашої підтримки. Пожертви допомагають покрити час і постійну роботу над Wine Bar, даючи мені причину продовжувати його розробку. Якщо ж ви розробник, який комфортно працює з Dart/Flutter, розгляньте можливість приєднатися до команди.\n\nЗверніть увагу, що це повідомлення буде з\'являтися час від часу навіть якщо ви зробите пожертву, оскільки Wine Bar не стежить за тим, хто пожертвував, а хто ні.\n\nДякуємо за розуміння.';
