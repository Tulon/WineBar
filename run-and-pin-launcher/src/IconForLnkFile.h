...
/**
 * Extract an icon from a portable executable (.exe or .dll).
 *
 * @param filePath A Windows (not Unix) file path to the .lnk file.
 ...
 */
OwnedIcon iconForLnkFile(wchar_t const* filePath, int iconResolution);
