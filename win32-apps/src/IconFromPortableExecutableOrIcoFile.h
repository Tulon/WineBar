...
/**
 * Extracts an icon from either a portable executable (.exe or .dll) or from an .ico file.
 *
 * @param filePath A Windows (not Unix) file path to the portable executable / .ico file.
 * @param iconSelector Used to select a particular icon among many in a portable executable.
 *        Not used for .ico files, as the .ico file doesn't carry multiple icons but merely
 ...
 */
OwnedIcon iconFromPortableExecutableOrIcoFile(
